        ...
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:linear-gradient(180deg,#2D1B0E 0%,#1A0F06 80%);border:1px solid rgba(228,195,138,0.18);border-radius:18px;overflow:hidden;">
          ...
          <tr>
            <td align="center" style="padding:56px 32px 8px 32px;">
              <h1 style="margin:0;font-family:Georgia,'Times New Roman',serif;font-weight:300;font-size:56px;letter-spacing:-0.025em;color:#F8F2E5;line-height:1;">Rhei.</h1>
              <p style="margin:14px 0 0;font-family:Helvetica,Arial,sans-serif;font-size:10px;font-weight:500;letter-spacing:0.32em;text-transform:uppercase;color:#E4C38A;">A nervous system practice</p>
            </td>
          </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:rgba(228,195,138,0.06);border:1px solid rgba(228,195,138,0.22);border-radius:14px;margin:0 0 32px 0;">
                <tr>
                  <td style="padding:22px 24px;">
                    <p style="margin:0 0 8px 0;font-family:Helvetica,Arial,sans-serif;font-size:10px;font-weight:500;letter-spacing:0.28em;text-transform:uppercase;color:#E4C38A;">Begin here</p>
                    <p style="margin:0;font-family:Georgia,'Times New Roman',serif;font-size:19px;font-weight:300;line-height:1.35;color:#F8F2E5;letter-spacing:-0.01em;">
